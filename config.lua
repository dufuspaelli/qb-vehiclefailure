...
cfg = {
	...
	limpModeMultiplier = 0.01,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
...
repairCfg = {
	mechanics = {
		{name="Garage", id=446, r=3.0, x=-337.0,  y=-135.0,  z=39.0},	-- LSC Burton
		{name="Garage", id=446, r=3.0, x=-1155.0, y=-2007.0, z=13.0},	-- LSC by airport
		{name="Garage", id=446, r=3.0, x=734.0,   y=-1085.0, z=22.0},	-- LSC La Mesa
		{name="Garage", id=446, r=3.0, x=1177.0,  y=2640.0,  z=37.0},	-- LSC Harmony
		{name="Garage", id=446, r=3.0, x=108.0,   y=6624.0,  z=31.0},	-- LSC Paleto Bay
		{name="Garage", id=446, r=3.0, x=538.0,   y=-183.0,  z=54.0},	-- Mechanic Hawic
		{name="Garage", id=446, r=3.0, x=1774.0,  y=3333.0,  z=41.0},	-- Mechanic Sandy Shores Airfield
		{name="Garage", id=446, r=3.0, x=1143.0,  y=-776.0,  z=57.0},	-- Mechanic Mirror Park
		{name="Garage", id=446, r=3.0, x=2508.0,  y=4103.0,  z=38.0},	-- Mechanic East Joshua Rd.
		{name="Garage", id=446, r=3.0, x=2006.0,  y=3792.0,  z=32.0},	-- Mechanic Sandy Shores gas station
		--{name="Garage", id=446, r=3.0, x=484.0,   y=-1316.0, z=29.0},	-- Hayes Auto, Little Bighorn Ave.
		--{name="Garage", id=446, r=3.0, x=-1419.0, y=-450.0,  z=36.0},	-- Hayes Auto Body Shop, Del Perro
		{name="Garage", id=446, r=3.0, x=257.74,  y=-1800.6, z=27.1},	-- Hayes Auto Body Shop, Davis
	--	{name="Mechanic", id=446, r=3.0, x=288.0,   y=-1730.0, z=29.0},	-- Hayes Auto, Rancho (Disabled, looks like a warehouse for the Davis branch)
		--{name="Garage", id=446, r=3.0, x=1915.0,  y=3729.0,  z=32.0},	-- Otto's Auto Parts, Sandy Shores
		{name="Garage", id=446, r=3.0, x=-21.43,   y=-1676.54, z=29.49},	-- Mosley Auto Service, Strawberry
	--	{name="Garage", id=446, r=3.0, x=-212.0,  y=-1378.0, z=31.0},	-- Glass Heroes, Strawberry
		{name="Garage", id=446, r=3.0, x=258.0,   y=2594.0,  z=44.0},	-- Mechanic Harmony
		{name="Garage", id=446, r=3.0, x=-32.0,   y=-1090.0, z=26.0},	-- Simeons
		--{name="Garage", id=446, r=3.0, x=-211.0,  y=-1325.0, z=31.0},	-- Bennys
		--{name="Garage", id=446, r=3.0, x=903.0,   y=3563.0,  z=34.0},	-- Auto Repair, Grand Senora Desert
		--{name="Garage", id=446, r=3.0, x=437.0,   y=3568.0,  z=38.0}		-- Auto Shop, Grand Senora Desert
	},
